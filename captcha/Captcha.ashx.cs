...
namespace PruebaCaptcha
{
    public class Captcha1 : IHttpHandler,IReadOnlySessionState
    {
        public int numDigitos = 4;
        public bool soloNumerico= true;
