...
{
    public class Menu_hijos
    {
        //Base de datos
        private static Database db1 = DatabaseFactory.CreateDatabase(ConfigurationManager.AppSettings["conn"]);

        public int id_menuhijo { get; set; }
        ...
        public Menu_hijos(int id_menu_)
        {
            id_menu = id_menu_;
            RecuperarDatos();
        }
        public Menu_hijos(int id_menuhijo_, int id_menu_, string nombre_, bool activo_, string url_)
        {
            this.id_menuhijo = id_menuhijo_;
        ...
        public static DataTable lista_menu_hijo_x_menu(int id_menu_)
        {
            try
            {
                DbCommand cmd = db1.GetStoredProcCommand("lista_menu_hijo_x_menu");
                db1.AddInParameter(cmd, "id_menu", DbType.Int32, id_menu_);
